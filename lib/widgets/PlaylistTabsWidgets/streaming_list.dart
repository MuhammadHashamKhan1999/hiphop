...
class StreamingPlaylistScreen extends StatelessWidget {
  const StreamingPlaylistScreen({super.key});
            ...
            child: ListView.builder(
                ...
                itemBuilder: (_, index){
                  return ListTile(
                    ...
                    title: Text('Streaming One ', style: TextStyle(color: Colors.white),),
                    trailing: Container(
